    ...
    <ScrollView style={styles.container}>
      ...
      <View>
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', margin: 5 }}>
          ...
          <Chip key={index} style={{ margin: 2, backgroundColor: '#6495ED' }} mode="flat"><Text style={{color: '#FFD700' }}>{tag}</Text></Chip>
        )) : <Chip key={tags} style={{ margin: 2, backgroundColor: '#6495ED' }} mode="flat"><Text style={{color: '#FFD700' }}>{tags}</Text></Chip>
        }
        </View>
